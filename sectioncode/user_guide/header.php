...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="assets/css/sh.css"  media="screen,projection"/>
        <link rel="apple-touch-icon-precomposed" href="assets/images/favicon/bettercodes-logo.png">
        <meta name="msapplication-TileColor" content="#FFFFFF">
        <meta name="msapplication-TileImage" content="assets/images/favicon/bettercodes-logo.png">
        <link rel="icon" href="assets/images/favicon/bettercodes-logo.png" sizes="32x32">
            ...
            <ul style="transform: translateX(0px);" id="nav-mobile" class="side-nav fixed">
                <li class="logo">
                    <a id="logo-container" href="index.php" class="brand-logo">
                        <img id="front-page-logo" src="assets/image/bettercodes-logo-f.png" /></a></li>
                <li class="search">
                ...
                <li class="bold"><a href="about.php" class="waves-effect waves-teal">Sobre</a></li>
                <li class="bold"><a href="getting-started.php" class="waves-effect waves-teal">Começando</a></li>
                <li class="bold"><a href="creat-pages.php" class="waves-effect waves-teal">Criar novas páginas</a></li>
                <li class="no-padding">
